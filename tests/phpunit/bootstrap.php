...
// Make CRM_Events_ExtensionUtil available.
require_once __DIR__ . '/../../events.civix.php';
...
addExtensionToClassLoader('net.bund.civicrm.events');
 ...
 */
function _events_test_civicrm_container(ContainerBuilder $container): void {
}
